...
export const mockRightContent = `<div style="margin: 1rem">
   <p></p>
   <h3>Websites</h3>
   ...
   <h3>
      ...
      <a target="_blank" title="https://docs.eiam.swiss/?c=eiam" href="https://docs.eiam.swiss/?c=eiam">
         New technical documentatio
         <nobr>n<span style="font-size:80%;text-decoration:none"><img src="images/extern.svg" style="height:0.9em;vertical-align:baseline;margin-left:3px"></span></nobr>
      </a>
      </span>
   </h3>
   ...
   <p></p>
   <p></p>
   <h3> <a href="index.php?c=bitreleaseplan&amp;l=en">eIAM-Release Plan⇨</a> </h3>
   The release notes describe changes to the eIAM service and new functionalities.
   <p></p>
   <p><span class="bold">Internal:</span></p>
   <h3> <a href="index.php?c=!forumlist&amp;l=en">Discussion forum⇨</a> </h3>
   eIAM, questions and discussions, moderated by the <span title="Federal Chancellery FCh, Digital Transformation and ICT Governance DTI" onclick="thistitle=this.title;thisinnerHTML=this.innerHTML;this.innerHTML=thistitle;this.title=thisinnerHTML" style="cursor:pointer;text-decoration-line:underline;text-decoration-style:dotted;text-decoration-color:#aaa;">FCh DTI</span>
   <p></p>
   <p></p>
   <h3> <a href="index.php?c=!bkdti!soundingboard&amp;l=en">Sounding board⇨</a> </h3>
   Description of forthcoming releases, P035 status and roadmap
   <p></p>
   <p></p>
   <h3> <a href="index.php?c=eiam!dossier&amp;l=en">eIAM dossier⇨</a> </h3>
   New: Procuring an application or connecting an application to eIAM? Please open your eIAM dossier online
   <p></p>
   <p></p>
   <h3> <a href="index.php?c=!eiam!calc!2026&amp;l=en">eIAM tariff⇨</a> </h3>
   Calculate your recurring costs
   <p></p>
   <p></p>
   <dl class="freeImgLeft" style="width:189px;">
      <dt><a href="index.php?c=eiamsquidlink&amp;l=en"><img style="width:189px;" title="eIAM Logo" alt="eIAM Logo" src="f.php?f=r/eiamsquid/eiamsquid_de.svg?t=1712749449"></a></dt>
      <dd></dd>
   </dl>
</div>`
